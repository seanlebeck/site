...
<img class="checkbid" id="profile<?php echo $id; ?>" onclick="toggle_visibility('sub-menu')" style="transition: zoom 10s ease-in-out 0s;width:auto; height:30px;max-height:30px;outline:none;"src="images/nocomment.png" valign="middle" />
...
//	$("#commentheader")[0].innerHTML = newmessage;
    ...
    function waitForMsg(){
        ...
        $.ajax({
            type: "POST",
            url: "dropdown/dropnotification/get_commentcount.php",
