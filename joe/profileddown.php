...
<img class="profile" id="profile<?php echo $id; ?>" onclick="toggle_visibility('profile-sub-menu')" style="transition: zoom 10s ease-in-out 0s;width:auto; height:30px;max-height:30px;"src="<?php if(isset($_COOKIE[$ck_session])) { echo "images/profile.png"; } else {  echo "images/home.png"; }?>" valign="middle" />
...
$('#sub-menu').hide()
	...
	right: 25px;
		...
		<div style="background:#EDEDED;" id="two_comments<?php echo $id; ?>">
		
				
				<div type="hidden" id="lastviewedmsg"></div>
			
		<div id="comment_ui" style="padding:0 0 0 0;width:200px;line-height:40px;background:#EDEDED;" class="comment_ui">	
		<div  style="background:#EDEDED;" class="comment_text">		
...
<tr>
			...
			<div class="bbbbbbb" id="view<?php echo $id; ?>">
					<div style="background-color:#EDEDED; border-bottom-left-radius: 3px; border-bottom-right-radius: 3px; position: relative; z-index: 100; cursor:pointer;">
