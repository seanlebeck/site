...
?>
	...
	<div style="padding:3px;"><a STYLE="font-size:14px;font-weight:bold;" href="<?php echo $country_url; ?>" class=""><?php echo $country['countryname']; ?> <?php if($show_region_adcount) echo "(".(0+$country_adcounts[$country['countryid']]).")"; ?></a></div>
	...
	?>
			...
			<span style="color:orange;">&bull;</span><a href="<?php echo $city_url; ?>" class=""><?php echo $city['cityname']; ?> <?php if($show_city_adcount) echo "(".(0+$city_adcounts[$city['cityid']]).")"; ?></a><br>
