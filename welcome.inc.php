...
<table cellpadding="0" cellspacing="0" style="background:white;border:1px solid lightgray;margin-right:5px;border-radius: 3px;-moz-border-radius: 3px;">
<tr>
...
<input name="search" size="20" style="border:0px;color:gray;font-size:12px;padding-left:5px;" type="text" value="<?php echo $lang['SF3']; ?>" onFocus="clearText(this)">
